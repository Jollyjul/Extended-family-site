...
#   I18n is the Internationalization module. See config/environment.rb
...
# I am not using this because it is too limiting
#  def test_email_with_valid_examples 
#    user = @valid_user 
#    valid_endings = %w{com org net edu es jp ca info} 
